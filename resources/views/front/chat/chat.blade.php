...
<div>
    <div class="container-fluid m-0 d-flex p-2">
        ...
        <div style="width: 50px;height: 50px">
            <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0r8XXs7Wn28B7qPOEvsRNmUMNp4rC6P4f9N2P5tEy0Q&s"
                alt="" width="100%" height="100%" style="border-radius: 50%">
        </div>
    ...
    <div class="container-fluid w-100 px-3 py-2 d-flex" style="background: #131f45;height: 62px">
        ...
        <div id="button-submit" class="text-center"
             style="background: #4acfee;width: 50px;border-radius: 5px;cursor: pointer">
...
<script>
    ...
    $('#button-submit').on('click', function () {
        ...
        $('#content-box').append(`
              <div class="mb-2">
                <div class="float-right px-3 py-2" style="width: 270px;background: #4acfee;border-radius: 15px ">
                    ` + $value + `
                </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                <div class="mr-2" style="width: 45px;height: 45px">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0r8XXs7Wn28B7qPOEvsRNmUMNp4rC6P4f9N2P5tEy0Q&s" alt="" width="100%" height="100%" style="border-radius: 50%">
                </div>
