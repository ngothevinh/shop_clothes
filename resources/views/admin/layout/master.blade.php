                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-right mr-2">
                                                                <a href="./admin/login" class="btn-pill btn-shadow btn-shine btn btn-focus">
                                                                    Logout
                                                                </a>
                                                            </div>
                                                        </div>
                    ...
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="./admin/image_generate" class="{{ (request()->segment(2) == 'image_generate') ? 'mm-active' : '' }}">
                                        <i class="metismenu-icon"></i>Image Generate
                                    </a>
                                </li>
                            </ul>
                        </li>
