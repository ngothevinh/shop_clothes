                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form method="post" action="/admin/user/{{$user->id}}" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="name" id="name" placeholder="Name" type="text"
                                           class="form-control" value="{{$user->name}}"   @error('name')is-invalid @enderror>
                                    @error('name')
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="email" id="email" placeholder="Email" type="email"
                                           class="form-control" value="{{$user->email}}"  @error('email')is-invalid @enderror>
                                    @error('email')
                                    <div class="alert alert-danger validate">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="password" id="password" placeholder="Password" type="password"
                                           class="form-control" value="{{$user->password}}" @error('password')is-invalid @enderror>
                                    @error('password')
                                    <div class="alert alert-danger validate">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="password_confirmation" id="password_confirmation"
                                           ...
                                           class="form-control" value="{{$user->password_confirmation}}" @error('password_confirmation')is-invalid @enderror>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="street_address" id="street_address"
                                           ...
                                           @error('street_address')is-invalid @enderror
                                    >
                            ...
                            <div class="position-relative row form-group">
                                <label for="postalcode_zip" class="col-md-3 text-md-right col-form-label">
                                    Postcode Zip
                                </label>
                                <div class="col-md-9 col-xl-8">
                                    <input name="postalcode_zip" id="postcode_zip"
                                           placeholder="Postcode Zip" type="text" class="form-control"
                                           value="{{$user->postalcode_zip}}"
                                           @error('postalcode_zip')is-invalid @enderror
                                    >
                                    @error('postalcode_zip')
                                    <div class="alert alert-danger validate">{{$message}}</div>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="town_city" id="town_city" placeholder="Town City"
                                           ...
                                           @error('town_city')is-invalid @enderror
                                    >
                                    @error('town_city')
                                    <div class="alert alert-danger validate">{{$message}}</div>
                                    @enderror
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <textarea name="description" id="description" class="form-control"@error('description')is-invalid @enderror>{{$user->description}}</textarea>
                                    @error('description')
                                    <div class="alert alert-danger validate">{{ $message }}</div>
                                    @enderror
                                </div>
